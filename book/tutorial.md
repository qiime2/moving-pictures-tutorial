...
(You can learn more about viewing Visualizations, including alternatives to QIIME 2 View if you can't use that for any reason, [here](https://use.qiime2.org/en/2026.7/how-to-guides/view-visualizations.html).)
...
To learn about how to import sequence data in other formats, see *[How to import data for use with QIIME 2](https://amplicon-docs.readthedocs.io/en/2026.7/how-to-guides/how-to-import.html)*.
...
As discussed above, Visualizations can be viewed by loading them with [QIIME 2 View](https://view.qiime2.org) or using one of the alternative mechanisms discussed [here](https://use.qiime2.org/en/2026.7/how-to-guides/view-visualizations.html).
